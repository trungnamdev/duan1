...
<div class="khoahoc "> 
    <table >
        ...
        if (is_array($checksv)) { ?>
            ...
            <button type="button" disabled="disabled" class="btn btn-success dkkh" >Đã Đăng Ký</button>
            </td>
        </tr>
        ...
        <?php  
           ...
           <tr class="boxkhoahoc ">
            ...
            <p class="my-2 px-1"> <i class='far fa-file-alt' style='font-size:20px; color:gray'></i></i> <?=$demlh['tong']?> Lớp học</p>
            <p> <i class='fas fa-chalkboard-teacher' style='font-size:18px;color:gray'></i>
