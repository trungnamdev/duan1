 ...
 <div class="khoahoc ">
     <table id="chuakh">
         ...
         <tr class="boxkhoahoc ">
             ...
             <td class="gia">
                 <p class="my-2 px-1"> <i class='far fa-file-alt' style='font-size:20px; color:gray'></i>
                     <?= $demlh['tong'] ?> Lớp học <span
                         class="float-right mr-5 font-weight-bold"><?= chuyenso($kh['giatien']) ?> VND</span></p>
                 <p>
                     <?php
                         if (is_array($checksv)) { 
