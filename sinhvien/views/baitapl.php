...
<div class="header-box">
    <div class="tieude h1">BÀI TẬP - <?= $tenlop['tenlop'] ?></div>
    <div class="option-box">
        <a href="index.php?act=baitap&sx=all&idlop=<?=$idlop?>" class="<?= $all ?>">Tất cả (<?= count($checkbaitap) ?>)</a>
        <a href="index.php?act=baitap&sx=done&idlop=<?=$idlop?>" class="<?= $danop ?>">Đã nộp (<?= $btdanop ?>)</a>
        <a href="index.php?act=baitap&sx=not&idlop=<?=$idlop?>" class="<?= $nonop ?>">Chưa nộp (<?= $btchuanop ?>)</a>
