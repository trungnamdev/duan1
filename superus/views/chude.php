<div class="header-box">
    <div class="tieude h1">Quản lí Chủ Đề</div>
</div>
<div class="khoahoc">
<div class="addnew rounded-circle Regular shadow">
    
       <a href="index.php?act=formcd&cd=them"> <i class="fas fa-plus"></i></a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="index.php?act=formcd&cd=sua&idcd=<?=$cd['id']?>">
                ...
                <td class="text-center">
                    <a id="accept" href="index.php?act=xoacd&idcd=<?=$cd['id']?>">
