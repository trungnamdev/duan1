<div class="header-box">
    <div class="tieude h1">Quản lí Sinh Viên</div>
</div>
<div class="khoahoc">
<div class="addnew rounded-circle Regular shadow">
    
       <a href="index.php?act=addsinhvien&cn=them"> <i class="fas fa-plus"></i></a>
    ...
    <table class="table">
        ...
        <?php foreach($sv as $sv){?>
            ...
            <tr>
                <td scope="row">
                    <strong>Tên SV : </strong><?= $sv['hoten'] ?><br>
                ...
                <td class="text-center">
                    <a href="index.php?act=addsinhvien&cn=sua&id=<?= $sv['id'] ?>">
                ...
                <td class="text-center">
                    <a href="index.php?act=sinhvien&xoa=<?= $sv['id'] ?>">
