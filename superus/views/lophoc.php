<div class="header-box">
    <div class="tieude h1">Quản lí lớp học</div>
</div>
<div class="khoahoc">
<div class="addnew rounded-circle Regular shadow">
    
       <a href="index.php?act=themlh"> <i class="fas fa-plus"></i></a>
    ...
    <table class="table">
        ...
        ?>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="index.php?act=sualh&id=<?= $lh['idlop'] ?>">
                ...
                <td class="text-center">
                    <a href="index.php?act=xoalh&id=<?= $lh['idlop'] ?>">
